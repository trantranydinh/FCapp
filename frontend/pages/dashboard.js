...
import { RefreshCw, ArrowUpRight, Calendar, Download } from "lucide-react";
...
const DashboardPage = () => {
  ...
  const handleExportReport = async () => {
    try {
      // Prepare report data from current state
      const reportData = {
        ...
        primaryDriver: 'Supply Chain Constraints', // Mock for demo
